	...
	<div class="w-screen relative">
		<div class="grid gap-4 grid-cols-7 max-w-full px-8">
			...
			<div class="z-0 col-span-7">
				...
				<div
					class="z-10 bg-white relative mx-auto px-4 pt-4 pb-16 sm:pt-6 sm:pb-24 sm:px-6 lg:px-8"
				>
					<div class="text-center">
						...
						<p
							class="max-w-xl mx-auto text-xl text-gray-500"
						>
			...
			<img
				...
				class="z-20 relative mt-12 col-span-3"
				src="~/assets/lily_sketch.jpeg"
				alt="Lily Sketch"
			/>
			<div
				class="z-20 bg-white col-span-4 flex flex-col justify-center pl-8"
			>
			...
			<div
				class="flex col-span-7 gap-4 justify-center bg-white"
			>
				<div
					v-for="project in projects"
					:key="project.id"
					class="rounded-2xl h-96 w-72 relative shadow-md"
				>
					<div
					...
					>
						<div
							class="absolute top-0 right-0 -mt-4 mr-4 w-8 h-8 bg-gray-800 rounded-full"
						></div>
						<span
